...
class DatabaseConfig {
  ...
  async handleConnectionError(error) {
    if (this.retryCount < this.maxRetries) {
      ...
      logger.warn(`MongoDB connection attempt ${this.connectionAttempts} failed. Retrying in ${Math.round(delay/1000)}s... (${this.retryCount}/${this.maxRetries})`);
      ...
      logger.error(`MongoDB connection failed after ${this.maxRetries} attempts. Last error: ${error.message}`);
      this.isConnected = false;
      this.failed = true;
      return;
    }
